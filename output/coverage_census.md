...
- 生成: 2026-08-17T04:20:06+00:00（`python3 scripts/coverage_census.py`）
...
- 参考: 全ドライバー 79 / 稼働中 50（入力 116 件から重複 37 件を統合した後）
...
- 🈳 取得は動くがカード無し: 27 件
- ⏳ 裏取り待ちのみ（confirmed 0・provisional あり）: 11 ドライバー / 21 社
