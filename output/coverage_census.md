...
- 生成: 2026-08-19T01:33:14+00:00（`python3 scripts/coverage_census.py`）
...
- 参考: 全ドライバー 85 / 稼働中 57（入力 122 件から重複 37 件を統合した後）
...
- 🈳 取得は動くがカード無し: 25 件
- ⏳ 裏取り待ちのみ（confirmed 0・provisional あり）: 20 ドライバー / 30 社
  （参考: 全ドライバーの provisional を合算すると 79 社）
