...
- 生成: 2026-08-19T01:06:21+00:00（`python3 scripts/coverage_census.py`）
...
- 参考: 全ドライバー 82 / 稼働中 54（入力 119 件から重複 37 件を統合した後）
...
- 🈳 取得は動くがカード無し: 23 件
- ⏳ 裏取り待ちのみ（confirmed 0・provisional あり）: 18 ドライバー / 28 社
  （参考: 全ドライバーの provisional を合算すると 77 社）
