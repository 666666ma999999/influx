...
- 🈳 取得は動くがカード無し: 26 件
- ⏳ 裏取り待ちのみ（confirmed 0・provisional あり）: 11 ドライバー / 19 社
  （参考: 全ドライバーの provisional を合算すると 63 社）
...
| news_shock | 20 クエリ | 停止（最終 run=2026-08-17T10:12 だが成功クエリ 0） |
