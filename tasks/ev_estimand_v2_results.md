...
| pead_gap8_vol3 | — | +0.91% | -1.02% | +1.45% | +1.45% | -0.18% | 666 | 66 |
...
- 生成時刻: 2026-08-01T14:00:23+09:00 / ベースライン源: `output/base_rate/returns_w21.csv.gz`（凍結値= `output/base_rate/market_baseline_v2.json`）
...
| pead_gap8_vol3 | +0.43% [下限-1.40%] (65月) | +1.12% [下限-0.48%] (65月) |
