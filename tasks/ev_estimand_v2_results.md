...
| volshock_x_above200_quiet | +3.48% | +2.18% | -2.61% | — | +0.13% | -3.24% | 73 | 45 |
| shortcover_x_bear | — | -0.28% | -2.10% | +0.04% | -0.02% | -1.22% | 1639 | 38 |
| pead_gap8_vol3 | — | +0.91% | -1.02% | +1.45% | +1.45% | -0.18% | 666 | 66 |
| sue_x_above200 | +1.88% | +1.67% | -0.56% | — | +1.56% | -0.38% | 516 | 55 |
...
- 生成時刻: 2026-08-01T14:15:58+09:00 / ベースライン源: `output/base_rate/returns_w21.csv.gz`（凍結値= `output/base_rate/market_baseline_v2.json`）
...
| sue_x_above200 | +0.96% [下限-1.36%] (54月) | +1.21% [下限-0.73%] (54月) |
| volshock_x_above200_quiet | +2.31% [下限-2.11%] (45月) | +0.41% [下限-2.92%] (45月) |
